...
|----------|------------|----------|
| agent, subagent, orchestration, SDK | `apex/skills/building-agents/SKILL.md` | High |
| autonomous, loop, ralph, run until done, handoff | `apex/skills/autonomous-loop/SKILL.md` | High |
| prd, requirements, feature spec, plan feature | `apex/skills/prd-generator/SKILL.md` | High |
| UI, frontend, design, CSS, component, styling | `apex/skills/apex-design/SKILL.md` | High |
| architecture, database, API, schema, testing | `apex/skills/apex-sdlc/SKILL.md` | High |
| prompt injection, guardrails, agent security | `apex/skills/building-agents/references/security-guardrails.md` | High |
| hybrid attack, cross-context, browser agent | `apex/skills/building-agents/references/security-guardrails.md` | High |
| bug, fix, error, debug, issue, broken, failing, crash | `apex/skills/bug-comorbidity/SKILL.md` | High |
| APEX audit, audit APEX, project audit, health check, modernize | `apex/skills/project-audit/SKILL.md` | High |
| browser test, UI verify, visual test, take_snapshot | `apex/skills/browser-verification/SKILL.md` | Medium |
| AI testing, generated tests, test automation | `apex/skills/apex-sdlc/SKILL.md` | Medium |
| commit, commit message, git message | `apex/skills/git-commit/SKILL.md` | Medium |
| review, security scan, audit, code quality | `apex/skills/code-review/SKILL.md` | Medium |
| visualize, codebase map, structure, explore | `apex/skills/codebase-visualizer/SKILL.md` | Medium |

**ALWAYS LOAD**: `apex/skills/self-improvement/SKILL.md` — Core instinct for all tasks.

**Legacy fallback** (if skills folder unavailable):

| Triggers | File |
|----------|------|
| UI, frontend, design | `apex/APEX_DESIGN.md` |
| architecture, database, API, testing, CI/CD | `apex/APEX_SDLC.md` |
...
*Full testing guide: `apex/APEX_SDLC.md` § Testing*
...
*Full guide*: `apex/skills/self-improvement/SKILL.md`
