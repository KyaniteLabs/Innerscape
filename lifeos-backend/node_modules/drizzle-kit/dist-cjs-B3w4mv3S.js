...
const require_dist_cjs$30 = require('./dist-cjs-B-GnoOa6.js');
...
`);
		...
		async (awsIdentityProperties) => {
			...
			const { fromIni } = await Promise.resolve().then(() => require_chunk.__toDynamicImportESM()(require("./dist-cjs-CkGeK2g2.js")));
		...
		async (awsIdentityProperties) => {
			...
			const { fromTokenFile } = await Promise.resolve().then(() => require_chunk.__toDynamicImportESM()(require("./dist-cjs-B0aRrr7i.js")));
