...
var require_dist_cjs$1 = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	var LoginCredentialsFetcher = class LoginCredentialsFetcher {
		...
		async refresh(token) {
			const { SigninClient, CreateOAuth2TokenCommand } = await Promise.resolve().then(() => require("./signin-C7D4OStK.js"));
...
var require_dist_cjs = /* @__PURE__ */ require_chunk.__commonJSMin(((exports) => {
	...
	const resolveAssumeRoleCredentials = async (profileName, profiles, options, visitedProfiles = {}, resolveProfileData) => {
		...
		if (!options.roleAssumer) {
			const { getDefaultRoleAssumer } = await Promise.resolve().then(() => require("./sts-C4wSdILt.js"));
	...
	const resolveSsoCredentials = async (profile, profileData, options = {}) => {
		const { fromSSO } = await Promise.resolve().then(() => require_chunk.__toDynamicImportESM()(require("./dist-cjs-BpEO118q.js")));
		return fromSSO({
			profile,
			logger: options.logger,
	...
	const resolveWebIdentityCredentials = async (profile, options) => Promise.resolve().then(() => require_chunk.__toDynamicImportESM()(require("./dist-cjs-B0aRrr7i.js"))).then(({ fromTokenFile }) => fromTokenFile({
