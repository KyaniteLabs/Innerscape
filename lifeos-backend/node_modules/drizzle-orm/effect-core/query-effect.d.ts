...
interface QueryEffect<Succes = never, Failure = DrizzleQueryError, Context = never> extends Effect.Effect<Succes, Failure, Context> {}
declare abstract class QueryEffect<Succes = never, Failure = DrizzleQueryError, Context = never> {
  static readonly [entityKind]: string;
  protected _effect: Effect.Effect<Succes, Failure, Context>;
  protected get effect(): Effect.Effect<Succes, Failure, Context>;
  private _pipe;
  get pipe(): {
    <A>(this: A): A;
  ...
  get [Effect.EffectTypeId](): Effect.Effect.VarianceStruct<Succes, Failure, Context>;
  [Symbol.iterator](): Effect.EffectGenerator<Effect.Effect<Succes, Failure, Context>>;
}
