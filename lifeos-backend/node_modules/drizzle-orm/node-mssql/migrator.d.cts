...
declare function migrate<TSchema extends Record<string, unknown>>(db: NodeMsSqlDatabase<TSchema>, config: MigrationConfig): Promise<void | __migrator_ts23.MigratorInitFailResponse>;
//#endregion
export { migrate };
