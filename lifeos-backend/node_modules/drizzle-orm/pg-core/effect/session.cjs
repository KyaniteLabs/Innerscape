...
var PgEffectPreparedQuery = class extends require_pg_core_session.PgBasePreparedQuery {
	...
	queryWithCache(queryString, params, query) {
		...
		return effect.Effect.gen(function* () {
			const cacheStrat = cache ? yield* effect.Effect.tryPromise(() => (0, __cache_core_cache_ts.strategyFor)(queryString, params, queryMetadata, cacheConfig)) : { type: "skip" };
			...
			return effect.Effect.fail(new __errors_ts.DrizzleQueryError(queryString, params, e instanceof Error ? e : void 0));
		}));
	}
};
...
var PgEffectTransaction = class extends require_pg_core_effect_db.PgEffectDatabase {
	...
	rollback = function* () {
		yield* effect.Effect.fail(new __errors_ts.TransactionRollbackError());
	};
	/** @internal */
