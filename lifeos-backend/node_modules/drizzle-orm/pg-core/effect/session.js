...
import { strategyFor } from "../../cache/core/cache.js";
...
var PgEffectPreparedQuery = class extends PgBasePreparedQuery {
	...
	queryWithCache(queryString, params, query) {
		...
		return Effect.gen(function* () {
			const cacheStrat = cache ? yield* Effect.tryPromise(() => strategyFor(queryString, params, queryMetadata, cacheConfig)) : { type: "skip" };
			...
			return Effect.fail(new DrizzleQueryError(queryString, params, e instanceof Error ? e : void 0));
		}));
	}
};
