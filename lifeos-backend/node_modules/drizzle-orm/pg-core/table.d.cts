...
type InfeInsertColumns<TColumns extends PgColumns> = Simplify<{ [Key in keyof TColumns & string as TColumns[Key]['_']['insertType'] extends never ? never : undefined extends TColumns[Key]['_']['insertType'] ? never : Key]: TColumns[Key]['_']['insertType'] } & { [Key in keyof TColumns & string as TColumns[Key]['_']['insertType'] extends never ? never : undefined extends TColumns[Key]['_']['insertType'] ? Key : never]?: TColumns[Key]['_']['insertType'] }>;
...
//#endregion
export { AnyPgTable, InfeInsertColumns, PgTable, PgTableExtraConfig, PgTableExtraConfigValue, PgTableFn, PgTableFnInternal, PgTableWithColumns, TableConfig, pgTable, pgTableCreator };
