...
var PgTimestampBuilder = class extends require_pg_core_columns_common.PgColumnBuilder {
...
var PgTimestampStringBuilder = class extends require_pg_core_columns_common.PgColumnBuilder {
