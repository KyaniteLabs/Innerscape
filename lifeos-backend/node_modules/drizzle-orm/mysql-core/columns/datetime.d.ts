...
declare class MySqlDateTimeBuilder extends MySqlColumnBuilder<{
...
declare class MySqlDateTime<T extends ColumnBaseConfig<'object date'>> extends MySqlColumn<T> {
  static readonly [entityKind]: string;
...
declare class MySqlDateTimeStringBuilder extends MySqlColumnBuilder<{
...
declare class MySqlDateTimeString<T extends ColumnBaseConfig<'string datetime'>> extends MySqlColumn<T> {
  static readonly [entityKind]: string;
  readonly fsp: number | undefined;
  constructor(table: AnyMySqlTable<{
    name: T['tableName'];
