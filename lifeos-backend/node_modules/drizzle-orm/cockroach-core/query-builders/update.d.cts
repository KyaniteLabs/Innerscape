...
type CockroachUpdateSetSource<TTable extends CockroachTable> = { [Key in keyof InferInsertModel<TTable>]?: GetColumnData<TTable['_']['columns'][Key]> | SQL | CockroachColumn | undefined } & {};
