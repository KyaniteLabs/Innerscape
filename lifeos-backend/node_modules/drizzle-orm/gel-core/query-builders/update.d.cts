...
import { Assume, NeonAuthToken, UpdateSet } from "../../utils.cjs";
...
type GelUpdateSetSource<TTable extends GelTable, TModel extends Record<string, any> = InferInsertModel<TTable>> = { [Key in keyof TModel & string]?: GetColumnData<TTable['_']['columns'][Key]> | SQL | GelColumn } & {};
