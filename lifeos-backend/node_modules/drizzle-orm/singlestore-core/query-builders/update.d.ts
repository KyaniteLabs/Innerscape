...
type SingleStoreUpdateSetSource<TTable extends SingleStoreTable, TModel extends Record<string, any> = InferInsertModel<TTable>> = { [Key in keyof TModel & string]?: GetColumnData<TTable['_']['columns'][Key], 'query'> | SQL | undefined } & {};
