...
declare class SQLiteSyncDialect extends SQLiteDialect {
  static readonly [entityKind]: string;
  migrate(migrations: MigrationMeta[], session: SQLiteSession<'sync', unknown, Record<string, unknown>, AnyRelations, V1.TablesRelationalConfig>, config?: string | MigrationConfig): void | MigratorInitFailResponse;
}
declare class SQLiteAsyncDialect extends SQLiteDialect {
  static readonly [entityKind]: string;
  migrate(migrations: MigrationMeta[], session: SQLiteSession<'async', unknown, Record<string, unknown>, AnyRelations, V1.TablesRelationalConfig>, config?: string | MigrationConfig): Promise<void | MigratorInitFailResponse>;
}
//#endregion
