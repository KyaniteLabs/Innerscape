...
import { DrizzleTypeError, UpdateSet, ValueOrArray } from "../../utils.cjs";
...
type SQLiteUpdateSetSource<TTable extends SQLiteTable, TModel extends Record<string, any> = InferInsertModel<TTable>> = { [Key in keyof TModel & string]?: GetColumnData<TTable['_']['columns'][Key], 'query'> | SQL | SQLiteColumn | undefined } & {};
